...
function renderWinners() {
    ...
    const winTop3 = win1.slice(-3);
    const winTop2 = win1.slice(-2);
    const winTod3 = getPermutations(winTop3);
                ...
                html += `
                    <div style="margin-bottom:15px; border:1px solid #f1f5f9; border-radius:8px; padding:10px;">
                        ...
                        <table style="width:100%; border-collapse:collapse;">
                            ${items.map(i => `
                                <tr>
                                    <td style="padding:5px 0;"><span class="badge" style="background:#dcfce7; color:#166534; font-weight:bold; font-size:11px; padding:2px 8px;">${i.type}</span></td>
